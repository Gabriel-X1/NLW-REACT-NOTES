...
export function NewNoteCard( {onNoteCreated}: NewNoteCardProps){
    ...
    return (
        <Dialog.Root>
            ...
            <Dialog.Trigger className='rounded-md flex flex-col text-left outline-none bg-slate-700 p-5 gap-3 hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400' >

                <span className='text-sm font-medium text-slate-200'>Adicionar nota</span>

                <p className='text-sm leading-6 text-slate-400'>
                    Grave uma nota em áudio que sera convertida para texto automaicamente
                </p>
